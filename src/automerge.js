...
function receiveSyncMessage(doc, message, oldSyncState) {
  const [backendState, syncState, patch] = backend.receiveSyncMessage(Frontend.getBackendState(doc), message, oldSyncState)
